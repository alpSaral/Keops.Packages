...
namespace Keops.AspNetCore.DataTables
{
    ...
    public class DataTablesResponse : IDataTablesResponse
    {
        ...
        private bool IsSuccessResponse() => Data != null && string.IsNullOrWhiteSpace(Error);
        ...
        public virtual string SerializeData(object data) => JsonSerializer.Serialize(data, _settings);
        ...
        protected DataTablesResponse(int draw, string errorMessage): this(draw, errorMessage, null){ }
        ...
        protected DataTablesResponse(int draw, int totalRecords, int totalRecordsFiltered, object data): this(draw, totalRecords, totalRecordsFiltered, data, null){ }
        ...
        public static DataTablesResponse Create(IDataTablesRequest request, int totalRecords, int totalRecordsFiltered, object data) => Create(request, totalRecords, totalRecordsFiltered, data, null);
        ...
        /// <param name="errorMessage">Error message.</param>
        /// <returns>The response object.</returns>
        public static DataTablesResponse Create(IDataTablesRequest request, string errorMessage) => Create(request, errorMessage, null);
