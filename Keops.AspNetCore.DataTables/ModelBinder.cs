...
namespace Keops.AspNetCore.DataTables
{
    ...
    public class ModelBinder : IModelBinder
    {
        ...
        public Task BindModelAsync(ModelBindingContext bindingContext) => Task.Factory.StartNew(() => BindModel(bindingContext, Configuration.Options, ParseAdditionalParameters));
        ...
        public virtual void BindModel(ModelBindingContext bindingContext, IOptions options, Func<ModelBindingContext, IDictionary<string, object>> parseAditionalParameters)
        {
            ...
            int _draw = 0;
            if (options.IsDrawValidationEnabled && !Parse<int>(draw, out _draw))
            {
