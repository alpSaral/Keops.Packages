using Keops.AspNetCore.DataTables.NameConvention;
...
namespace Keops.AspNetCore.DataTables
{
    ...
    public class Options(int defaultPageLength, bool enableDrawValidation, bool enableRequestAdditionalParameters, bool enableResponseAdditionalParameters, IRequestNameConvention requestNameConvention, IResponseNameConvention responseNameConvention) : IOptions
    {
        /// <summary>
        /// Creates a new 'Option' instance.
        /// </summary>
        ...
        /// </summary>
        public int DefaultPageLength { get; private set; } = defaultPageLength;

        /// <summary>
        /// Gets an indicator if draw parameter should be validated.
        /// </summary>
        public bool IsDrawValidationEnabled { get; private set; } = enableDrawValidation;

        /// <summary>
        /// Gets an indicator whether request aditional parameters parsing is enabled or not.
        /// </summary>
        public bool IsRequestAdditionalParametersEnabled { get; private set; } = enableRequestAdditionalParameters;

        /// <summary>
        /// Gets an indicator whether response adicional parameters parsing is enabled or not.
        /// </summary>
        public bool IsResponseAdditionalParametersEnabled { get; private set; } = enableResponseAdditionalParameters;

        /// <summary>
        /// Gets the request name convention to be used when resolving request parameters.
        /// </summary>
        public IRequestNameConvention RequestNameConvention { get; private set; } = requestNameConvention;
        /// <summary>
        /// Gets the response name convention to be used when serializing response elements.
        /// </summary>
        public IResponseNameConvention ResponseNameConvention { get; private set; } = responseNameConvention;
